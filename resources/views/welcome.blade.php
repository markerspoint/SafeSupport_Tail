...
<body>
                            ...
                            @foreach ($articles as $article)
                                <div
                                    ...
                                    <div class="h-48 w-full relative overflow-hidden group">
                                        ...
                                        <div class="absolute inset-0 opacity-0 group-hover:opacity-40 transition-opacity duration-500 pointer-events-none"
                                            style="background: linear-gradient(to top, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0) 70%);">
                                        </div>
                                        <div
                                            ...
                                            <a class="flex items-center">
                                                <img src="{{ asset('img/safesupport-logo.png') }}"
                                                    ...
                                                    class="w-[10rem] h-[4rem] object-contain relative z-10">
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="mt-4 text-center">
                <x-button text="More Articles" href="#">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        class="lucide lucide-arrow-up-right size-4 shrink-0 transition-transform group-hover:-translate-y-1 group-hover:translate-x-1">
            ...
            <div class="mb-12 grid gap-8 lg:grid-cols-[1fr,auto]">
                <div class="max-w-2xl">
                    ...
                    <p class="text-base font-semibold text-muted-foreground md:text-lg text-green-700">
                        SafeSupport helps students access counseling, explore mental health resources, and connect with
                        professional counselors.
                        Whether you need guidance, support, or just a safe space to talk, SafeSupport empowers you to
                ...
                <div class="flex flex-col gap-2 step-fill-wrapper">
                    <div class="flex gap-4">
                        <div class="relative flex flex-col items-center">
                            <div
                                class="relative flex h-8 w-8 flex-shrink-0 items-center justify-center overflow-hidden rounded-full bg-green-500/10">
                        ...
                        <div class="flex items-center h-8">
                            <p class="text-base"><span class="font-semibold text-foreground">Sign Up</span><span
                                    class="text-green-600"> to SafeSupport platform</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex items-center h-8">
                            <p class="text-base"><span class="font-semibold text-foreground">Book</span><span
                                    class="text-green-600"> counseling sessions with ease</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex items-center h-8">
                            <p class="text-base"><span class="font-semibold text-foreground">Access</span><span
                                    class="text-green-600"> mental health resources anytime</span></p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex items-center h-8">
                            <p class="text-base"><span class="font-semibold text-foreground">Celebrate</span><span
                                    class="text-green-600"> your well-being and progress!</span></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
                <div
                    ...
                    <p class="text-sm text-muted-foreground text-green-700">
                        Schedule one-on-one sessions with professional counselors to get guidance, support, and mental
                        wellness advice.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-muted-foreground text-green-700">
                        Explore articles, videos, and self-help tools tailored to support mental health and personal
                        development.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-muted-foreground text-green-700">
                        Keep track of your scheduled sessions, reschedule when needed, and get notified of updates from
                        your counselors.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-sm text-muted-foreground text-green-700">
                        Receive reminders for upcoming sessions, new resources, and important announcements to stay on
                ...
                <div
                    ...
                    <p class="text-sm text-muted-foreground text-green-700">
                        Join group sessions, mental health workshops, or school-wide events to enhance wellness and
                ...
                <div
                    ...
                    <p class="text-sm text-muted-foreground text-green-700">
                        Get help from our support team whenever you face technical issues or need assistance with your
                        account or sessions.
                    </p>
                </div>
            </div>
    ...
    <section class="relative pb-[4rem] bg-center bg-repeat bg-[length:100%_auto]"
        style="background-image: url('{{ asset('img/landingpage/bg-default-1.png') }}');">
        <div class="absolute inset-0 bg-white/70"></div>
        ...
        <div class="flex justify-center z-10">
            <div
                class="relative w-[20rem] xs:w-[25rem] sm:w-[30rem] md:w-[45rem] lg:w-[60rem]
                       ...
                       text-center text-white mt-4 rounded-2xl shadow-lg">

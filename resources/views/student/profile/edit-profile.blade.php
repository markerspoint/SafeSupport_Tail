...
<div class="bg-pine-50 min-h-full p-6">
    <div class="max-w-md mx-auto bg-white border border-gray-200 rounded-lg p-6">
        <h1 class="text-2xl font-bold text-pine-900 mb-6">Edit Profile</h1>
        <form action="{{ route('counselor.profile.update') }}" method="POST" class="space-y-6">
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <a href="{{ route('counselor.profile') }}" class="inline-flex h-11 items-center px-6 text-sm font-medium text-gray-600 border border-gray-200 rounded-md hover:bg-gray-50 transition-colors">Cancel</a>

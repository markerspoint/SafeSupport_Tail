    ...
    <div class="w-full max-w-7xl mx-auto px-6 lg:px-8 overflow-x-auto">
        <div class="flex flex-col md:flex-row max-md:gap-3 items-center justify-between mb-5">
            <div class="flex items-center gap-4">
                ...
                <h6 class="text-xl leading-8 font-semibold text-gray-700" id="calendar-title"></h6>
            </div>
            ...
            <button id="new-event-btn" class="py-2.5 pr-7 pl-5 bg-[#10b981] rounded-xl flex items-center gap-2 text-base font-semibold text-white transition-all duration-300 hover:bg-success-700">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
            <div id="calendar" class="border-none"></div>
        </div>
            ...
            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-900">
                    ...
                    <form id="new-event-form" class="p-4">
                        ...
                        <div class="mb-4">
                            <label for="event-color" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color</label>
                            <select id="event-color" name="color" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-success-500 focus:border-success-500 block w-full p-2.5 dark:bg-gray-800 dark:border-gray-700 dark:text-white" required>
                                <option value="#8EC4E6">Pastel Blue</option>
                                <option value="#C1E87A">Pastel Green</option>
                                <option value="#FF999E">Pastel Red</option>
                                <option value="#FFE8A3">Pastel Yellow</option>
                                <option value="#B19CD9">Pastel Purple</option>
                            </select>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="flex items-center gap-3">
                            <button type="submit" id="save-event-btn" class="w-full text-white bg-[#10b981] hover:bg-success-700 focus:ring-4 focus:outline-none focus:ring-success-300 font-medium rounded-lg text-sm px-5 py-2.5">Save</button>
...
<script>
    function darkenHexColor(hex, percent = 20) {
        hex = hex.replace('#', '');
        const r = Math.max(0, parseInt(hex.slice(0, 2), 16) * (1 - percent / 100));
        const g = Math.max(0, parseInt(hex.slice(2, 4), 16) * (1 - percent / 100));
        const b = Math.max(0, parseInt(hex.slice(4, 6), 16) * (1 - percent / 100));
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            eventDidMount: function (info) {
                const borderColor = darkenHexColor(info.event.backgroundColor);
                info.el.style.borderColor = borderColor;
                info.el.style.color = '#4B5563'; 
            },
            select: function (info) {
                console.log('Select triggered:', info);
                eventIdInput.value = '';
                eventTitleInput.value = '';
                eventColorInput.value = '#8EC4E6'; 
            ...
            eventClick: function (info) {
                ...
                eventColorInput.value = info.event.backgroundColor || '#8EC4E6';
            ...
            eventDrop: function (info) {
                ...
                fetch(`{{ url('/counselor/schedules') }}/${info.event.id}`, {
                    ...
                    info.event.setProp('textColor', '#4B5563'); // Set text color to gray-600
                }).catch(error => {
            ...
            datesSet: function (info) {
                console.log('Dates set:', info.view.title);
        ...
        newEventForm.addEventListener('submit', function (e) {
            ...
            if (title && color && start && end) {
                console.log('Submitting event:', { id, title, color, start, end });
                ...
                .then(data => {
                    ...
                    if (id) {
                        ...
                        event.setProp('textColor', '#4B5563'); // Set text color to gray-600
                        ...
                        calendar.addEvent({
                            ...
                            textColor: '#4B5563', // Set text color to gray-600
                            start: data.start,
                            end: data.end
                        });
                    }
        ...
        newEventBtn.addEventListener('click', function () {
            ...
            eventIdInput.value = '';
            eventTitleInput.value = '';
            eventColorInput.value = '#8EC4E6'; // Default pastel blue

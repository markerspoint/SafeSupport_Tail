...
<body>
    ...
    <section class="relative pb-[4rem] pt-[2rem] bg-center bg-repeat bg-[length:100%_auto]" style="background-image: url('{{ asset('img/landingpage/bg-default-1.png') }}');">
        ...
        <div x-data="{ 
            ...
            <div x-data="{ id: $id('accordion') }" :class="{ 'border-green-200/60 text-green-800' : activeAccordion==id, 'border-transparent text-neutral-600 hover:text-neutral-800' : activeAccordion!=id }" class="duration-200 ease-out bg-white border rounded-md cursor-pointer group" x-cloak>
                <button @click="setActiveAccordion(id)" class="flex items-center justify-between w-full px-5 py-4 font-semibold text-left select-none">
                    ...
                    <div :class="{ 'rotate-90': activeAccordion==id }" class="relative flex items-center justify-center w-2.5 h-2.5 duration-300 ease-out">
                        ...
                        <div :class="{ 'rotate-90': activeAccordion==id }" class="absolute w-full h-0.5 ease duration-500 bg-neutral-500 group-hover:bg-green-800 rounded-full"></div>
                    </div>
                </button>
                <div x-show="activeAccordion==id" x-collapse x-cloak>
                    <div class="p-5 pt-0 opacity-70">
                        SafeSupport is a student-friendly platform that helps you book counseling sessions, access mental health resources, and connect with professional counselors—all in one place.
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ id: $id('accordion') }" :class="{ 'border-green-200/60 text-green-800' : activeAccordion==id, 'border-transparent text-neutral-600 hover:text-neutral-800' : activeAccordion!=id }" class="duration-200 ease-out bg-white border rounded-md cursor-pointer group" x-cloak>
                ...
                <div x-show="activeAccordion==id" x-collapse x-cloak>
                    <div class="p-5 pt-0 opacity-70">
                        SafeSupport is designed for students who want easy access to counseling and mental health support, but anyone in the student community can benefit from its resources.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div x-data="{ 
            ...
            <div x-data="{ id: $id('accordion') }" :class="{ 'border-green-200/60 text-green-800' : activeAccordion==id, 'border-transparent text-neutral-600 hover:text-neutral-800' : activeAccordion!=id }" class="duration-200 ease-out bg-white border rounded-md cursor-pointer group" x-cloak>
                ...
                <div x-show="activeAccordion==id" x-collapse x-cloak>
                    <div class="p-5 pt-0 opacity-70">
                        Schedule one-on-one sessions with available counselors, choose your preferred date and time, and manage bookings directly from your dashboard.
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ id: $id('accordion') }" :class="{ 'border-green-200/60 text-green-800' : activeAccordion==id, 'border-transparent text-neutral-600 hover:text-neutral-800' : activeAccordion!=id }" class="duration-200 ease-out bg-white border rounded-md cursor-pointer group" x-cloak>
                ...
                <div x-show="activeAccordion==id" x-collapse x-cloak>
                    <div class="p-5 pt-0 opacity-70">
                        Cancel or reschedule your upcoming sessions, and get notifications if your counselor updates availability.
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ id: $id('accordion') }" :class="{ 'border-green-200/60 text-green-800' : activeAccordion==id, 'border-transparent text-neutral-600 hover:text-neutral-800' : activeAccordion!=id }" class="duration-200 ease-out bg-white border rounded-md cursor-pointer group" x-cloak>
                ...
                <div x-show="activeAccordion==id" x-collapse x-cloak>
                    <div class="p-5 pt-0 opacity-70">
                        Receive email or dashboard notifications for upcoming appointments, new resources, or important announcements.
                    </div>
                </div>
            </div>
            ...
            <div x-data="{ id: $id('accordion') }" :class="{ 'border-green-200/60 text-green-800' : activeAccordion==id, 'border-transparent text-neutral-600 hover:text-neutral-800' : activeAccordion!=id }" class="duration-200 ease-out bg-white border rounded-md cursor-pointer group" x-cloak>
                ...
                <div x-show="activeAccordion==id" x-collapse x-cloak>
                    <div class="p-5 pt-0 opacity-70">
                        Connect with counselors, explore mental health content, or contact support for technical or account assistance.
                    </div>
                </div>
            </div>
        </div>
